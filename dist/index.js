              ...
              messages.forEach(async (message) => {
                ...
                if (messageText) {
                  ...
                  if (userSessions[phoneNumber].messageCount === 1) {
                    ...
                    userSessions[phoneNumber].messageCount > 1 &&
                    messageType === "intro"
                  ) {
                  ...
                  if (
                    ["pcos", "yeastInfection", "periodPain"].includes(
                      messageType
                    )
                  ) {
                    if (
                      !userSessions[phoneNumber].preferredTopics.includes(
                        messageType
                      )
                    ) {
                      userSessions[phoneNumber].preferredTopics.push(
                        messageType
                      );
                    }
                  }
                  ...
                  if (
                    userSessions[phoneNumber].preferredTopics.length > 0 &&
                    messageType === "menu"
                  ) {
                    setTimeout(async () => {
                      const followUp =
                        "Based on our previous conversations, you might also be interested in our spa services or supplement recommendations. Just let me know! 🌸";
